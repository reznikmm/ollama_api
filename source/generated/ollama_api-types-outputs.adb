...
package body Ollama_API.Types.Outputs is
   ...
   begin
      ...
      if not Value.embeddings.Is_Null then
         ...
         for J in 1 .. Value.embeddings.Length loop
            Handler.Float_Value
              (Interfaces.IEEE_Float_64 (Float'(Value.embeddings (J))));
         end loop;
         Handler.End_Array;
      end if;
      if Value.total_duration.Is_Set then
   ...
   begin
      ...
      if Value.total.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.total.Value)));
      end if;
      if Value.completed.Is_Set then
         Handler.Key_Name ("completed");
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.completed.Value)));
      end if;
      Handler.End_Object;
   ...
   begin
      ...
      if Value.seed.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.seed.Value)));
      end if;
      if Value.temperature.Is_Set then
         Handler.Key_Name ("temperature");
         Handler.Float_Value
           (Interfaces.IEEE_Float_64 (Value.temperature.Value));
      end if;
      if Value.top_k.Is_Set then
         Handler.Key_Name ("top_k");
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.top_k.Value)));
      end if;
      if Value.top_p.Is_Set then
         Handler.Key_Name ("top_p");
         Handler.Float_Value (Interfaces.IEEE_Float_64 (Value.top_p.Value));
      end if;
      if Value.min_p.Is_Set then
         Handler.Key_Name ("min_p");
         Handler.Float_Value (Interfaces.IEEE_Float_64 (Value.min_p.Value));
      end if;
      ...
      if Value.num_ctx.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.num_ctx.Value)));
      end if;
      if Value.num_predict.Is_Set then
         Handler.Key_Name ("num_predict");
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.num_predict.Value)));
      end if;
      Handler.End_Object;
   ...
   begin
      ...
      if Value.dimensions.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.dimensions.Value)));
      end if;
   ...
   begin
      ...
      if Value.logprob.Is_Set then
         ...
         Handler.Float_Value (Interfaces.IEEE_Float_64 (Value.logprob.Value));
      end if;
      if not Value.bytes.Is_Null then
         ...
         for J in 1 .. Value.bytes.Length loop
            Handler.Integer_Value
              (Interfaces.Integer_64 (Integer'(Value.bytes (J))));
         end loop;
         Handler.End_Array;
      end if;
      Handler.End_Object;
   ...
   begin
      ...
      if Value.size.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.size.Value)));
      end if;
      if not Value.digest.Is_Null then
         Handler.Key_Name ("digest");
         Handler.String_Value (Value.digest);
   ...
   begin
      ...
      if Value.max_results.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.max_results.Value)));
      end if;
      Handler.End_Object;
   ...
   begin
      ...
      if Value.top_logprobs.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.top_logprobs.Value)));
      end if;
      Handler.End_Object;
   ...
   begin
      ...
      if Value.size_vram.Is_Set then
         ...
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.size_vram.Value)));
      end if;
      if Value.context_length.Is_Set then
         Handler.Key_Name ("context_length");
         Handler.Integer_Value
           (Interfaces.Integer_64 (Integer'(Value.context_length.Value)));
      end if;
      Handler.End_Object;
   end Output_Ps;
